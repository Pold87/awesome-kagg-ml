...
class draw_repeated_trip:
    ...
    def __init__(self,dataPath,driver=None, threshold=0.05, df_submission = None):
        ...
        for trip in trips:
            if '.csv' in trip:
                ...
                if self.check_trips(tripc, trip):
                    self.df_submission.loc[str(driver) + '_' + str(trip), 'prob'] = 1
...
if __name__ == "__main__":
    ...
    for driver in drivers:
        dd= draw_repeated_trip(dataPath=mypath,
                               driver=driver,
