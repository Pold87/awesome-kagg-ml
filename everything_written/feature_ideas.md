...
4. does the driver use a gps (does he follow some kind of optimal trajectory? This might only be inferrable for trips that occur often and are similar enough, also turning around a lot might be a valid feature-feature)
5. 
